...
export default function OptionSelect({ option, selectOption, isSelected, property, isMulti = false }: OptionSelectProps): JSX.Element {
  ...
  return (
    <div
      ...
      className={clsx("flex items-center justify-center px-2 py-1 rounded-xl border border-slate-300 cursor-pointer text-[6px] h-8", {
