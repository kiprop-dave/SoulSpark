...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center w-[90%] h-[80%] sm:w-[30%] bg-slate-50 rounded shadow shadow-gray-300">
      <img src={logo} alt='logo' className='h-20 w-20' />
      <div className='flex flex-col items-center w-full mt-5'>
        <h3 className='font-bold text-lg mb-8'>Sign in to your account</h3>
        <Button variant='default' className='w-5/6 mb-5 bg-red-500 h-[46px] rounded-xl text-white font-bold hover:opacity-95 hover:bg-red-500'>
          Sign in with Google
        </Button>
